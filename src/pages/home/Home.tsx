...
import StarProduct from '../../components/sections/starPoduct/StarProduct';
    ...
    <div className='flex flex-col gap-20 bg-linear-90 from-red-950/15 via-amber-50 to-red-950/15'>
      ...
      <section className='h-[96dvh] flex flex-col justify-center items-center text-center gap-14'>
        <ScrollReveal direction="none" scale={0.5} duration={0.6} blur={20} className='flex flex-col gap-4'>
          <span className='inline-block text-xs font-semibold tracking-[0.3em] uppercase text-red-950/50'>Producción confiable, sabor inigualable;</span>
          <h3 className='text-3xl md:text-4xl lg:text-6xl font-serif italic mb-6 text-red-900'>
